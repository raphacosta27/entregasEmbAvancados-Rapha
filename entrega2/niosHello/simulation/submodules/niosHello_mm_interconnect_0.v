...
module niosHello_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // pio_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_1_s1_agent:cp_data
	...
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> rom_s1_agent:cp_channel
	...
	wire  [95:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [95:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_006:sink_data
	...
	niosHello_mm_interconnect_0_router_003 router_003 (
	...
	niosHello_mm_interconnect_0_router_002 router_005 (
	...
	niosHello_mm_interconnect_0_router_003 router_007 (
	...
	niosHello_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosHello_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosHello_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosHello_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosHello_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
